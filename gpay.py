...
sri=gp.Google_pay("sriman007@gmail.com","8611111191","Sriman S")
sri.open_gpay()
sri.email_verification()
sri.mobile_verification()
sri.name_verification()
sri.otp_verification(15698,15698)
sri.Bank_verification()
sri.PanCard_Verification()
sri.set_Pin("5384")
sri.Enter_your_Pin(3465,3465)
...
man=Phone_pe("sriman007@gmail.com","9000000000","sriman")
man.open_phonepe()
man.mobile_verification()
man.name_verification()
man.otp_verification(780965,780965)
man.Bank_verification()
man.PanCard_Verification()
man.set_Pin("238790")
man.Enter_your_Pin(3564,3564)


        
googlepay=[{"name":"sriman","gpaynum":7397266887,"type":"personal","transaction":"regular"},
